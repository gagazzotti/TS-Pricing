...
def main():
    ...
    mellin_time_ts_p = get_time_mellin_bg(option_params, bg_params, eps_ts_p)
    df_bg = pd.concat([mellin_time_ts_p, proj_time_ts_p], axis=1)
...
def get_time_mellin_bg(option_params: dict, bg_params: dict, eps: dict):
    """TBD"""
    proj_price_ref = 0.2599191174562806
